...
public final class KailleraGameImpl implements KailleraGame
{
	...
	public synchronized int join(KailleraUser user) throws JoinGameException
	{
		...
		//{
			...
			announce("Help: " + getServer().getReleaseInfo().getProductName() + " v" + getServer().getReleaseInfo().getVersionString() + ": " + getServer().getReleaseInfo().getReleaseDate() + " - Visit: https://emulinker.org", user);
			announce("************************", user);
